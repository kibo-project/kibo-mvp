                                    ...
                                    <div className="flex justify-between items-start">
                                        <div className="flex-1">
                                            <CardTitle className="text-base mb-1 flex items-center gap-2">
                                                <span
                                                    className="text-neutral-900 dark:text-neutral-100">{order.id}</span>
                                            ...
                                            <div className="space-y-1">
                                                <p className="text-sm text-neutral-600 dark:text-neutral-400">
                                                    <span
                                                        className="font-medium">{`${order.cryptoAmount} ${order.cryptoCurrency}`}</span>
                            ...
                            <div className="p-6">
                                ...
                                <div className="space-y-4 mb-6">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <label
                                                className="text-sm font-medium text-neutral-700 dark:text-neutral-300">Crypto
                                                Amount</label>
                                            <p className="text-sm text-neutral-900 dark:text-neutral-100">{selectedOrder.cryptoAmount} {selectedOrder.cryptoCurrency}</p>
                                        </div>
                                        <div>
                                            <label
                                                className="text-sm font-medium text-neutral-700 dark:text-neutral-300">Fiat
                                                Amount</label>

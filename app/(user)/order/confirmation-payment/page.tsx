...
const ConfirmationPayment: NextPage = () => {
  ...
  const cryptoEquivalent = useMemo(() => {
    return fiatAmount > 0 ? fiatAmount / USDT_EXCHANGE_RATE : 0;
  }, [fiatAmount]);
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setSeconds(prev => {
        if (prev <= 0) {
          return COUNTDOWN_DURATION; // Auto-restart when reaches 0
        }
        return prev - 1;
      });
    }, 1000);
    ...
    <div className="md:mx-auto md:min-w-md px-4">
      <div className="kibo-page-header mb-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100">Payment Confirmation</h1>
        </div>
      </div>
      ...
      <div className="kibo-section-spacing">
        ...
        <Card>
          <CardBody>
            ...
            <div className="space-y-4">
              ...
              {/* Crypto Equivalent Display with Countdown */}
              <div className="py-3">
                <div className="flex justify-between items-center">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm font-medium text-neutral-600 dark:text-neutral-400">USDT</span>
                  </div>
                  <CircularCountdown seconds={seconds} maxSeconds={COUNTDOWN_DURATION} />
                </div>
                <div className="text-xs text-neutral-500 dark:text-neutral-400 mt-1">
                  1 USDT ≈ {USDT_EXCHANGE_RATE} Bs
                </div>
              </div>
            </div>
          </CardBody>
        ...
        <Button
          ...
          disabled={!fiatAmount || fiatAmount <= 0 || !recipient.trim() || isCreatingOrder}
          fullWidth
          size="lg"
          leftIcon={
            isCreatingOrder ? (
            ...
            <div className="text-center space-y-4">
              ...
              <div className="bg-neutral-50 dark:bg-neutral-800 rounded-lg p-4 space-y-3">
                ...
                <div className="flex justify-between pt-2 border-t border-neutral-200 dark:border-neutral-700">
                  <span className="text-sm text-neutral-600 dark:text-neutral-400">Crypto Amount:</span>

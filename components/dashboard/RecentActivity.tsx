            ...
            <div className="p-3">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <div
                            className={`w-10 h-10 rounded-full ${getStatusColor(order.status)} flex items-center justify-center`}>
                    ...
                    <div className="text-right">
                        <div className="font-semibold text-base-content">{order.fiatAmount} {order.fiatCurrency}</div>
                        <div
                            className="text-xs text-base-content opacity-60">{order.cryptoAmount} {order.cryptoCurrency}</div>
                    </div>
                </div>
            </div>
        );

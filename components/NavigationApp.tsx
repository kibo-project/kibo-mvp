...
export const NavigationApp = () => {
    ...
    return (
        <nav
            className="fixed bottom-0 z-10 w-full bg-base-100 dark:bg-base-300 border-t border-base-300 dark:border-base-200 shadow-lg md:hidden">
            <div className="flex items-center justify-around px-2 py-3">
                {currentMenuLinks.map(({label, href, icon}) => {
                    ...
                    return (
                        ...
                        >
                            <div
                                className={`transition-transform duration-200 mb-0.5 ${isActive ? "scale-110" : "scale-100"}`}>
                                {icon}
                            </div>

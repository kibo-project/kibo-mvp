...
export const mockOrders: Order[] = [
  // ORDEN COMPLETADA
  {
    ...
    qrImageUrl: 'https://via.placeholder.com/300x300/0066cc/ffffff?text=QR+Code+UNION',
    proofUrl: 'https://via.placeholder.com/400x600/00cc66/ffffff?text=Payment+Proof+300BOB',
    ...
    releaseTxHash: '0xdef456ghi789jkl012mno345pqr678stu901vwx234yz567abc123',
  ...
  // ORDEN TOMADA (EN PROGRESO)
  {
    ...
    qrImageUrl: 'https://via.placeholder.com/300x300/cc6600/ffffff?text=QR+Code+BISA',
  ...
  // ORDEN PENDIENTE DE PAGO
  {
    ...
    qrImageUrl: 'https://via.placeholder.com/300x300/cc0066/ffffff?text=QR+Pending+200BOB',
  ...
  // ORDEN CANCELADA
  {
    ...
    qrImageUrl: 'https://via.placeholder.com/300x300/cc3333/ffffff?text=QR+Cancelled',
  ...
  // ORDEN REFUNDED (por timeout)
  {
    ...
    qrImageUrl: 'https://via.placeholder.com/300x300/999999/ffffff?text=QR+Refunded',
    ...
    releaseTxHash: '0xghi789jkl012mno345pqr678stu901vwx234yz567abc123def456ghi',
    user: mockUsers[1],
    ally: mockUsers[2],
  ...
  // ÓRDENES COMPLETADAS ADICIONALES (para historial)
  {
    ...
    qrImageUrl: 'https://via.placeholder.com/300x300/0066cc/ffffff?text=QR+FIE+180',
    proofUrl: 'https://via.placeholder.com/400x600/00cc66/ffffff?text=Proof+180BOB',
    ...
    releaseTxHash: '0xjkl345mno678pqr901stu234vwx567yz890abc123def456ghi789jkl',
